(function() {
    ...
    media.innerHTML = "@media(min-width:" + 640 + "px){body{margin: 0 auto;width: " + 640 + "px;}.pc{left: 50%;right: initial;-webkit-transform: translate(-50%, 0);-ms-transform: translate(-50%, 0);-o-transform: translate(-50%, 0);transform: translate(-50%, 0);width: " + 640 + "px;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;}}";
